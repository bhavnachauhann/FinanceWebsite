   ...
   <>
    <div className="hero overlay sec blogsec">
        <div className="container">
          <h1 className="heading text-white mb-3 aos-init aos-animate textbold" data-aos="fade-up">
            Blog / News
          </h1>
        </div>
      </div>
    {/* sec-1 */}
    <div class="section">
    <div class="container article py-5">
      <div class="row justify-content-center align-items-stretch">
        ...
        <article class="col-lg-8 order-lg-2 px-lg-5">
          ...
          <h3 className='pt-4'>Even the all-powerful...</h3>
          ...
          <div class="pt-5">
            ...
            <ul class="comment-list">
              <li class="comment">
                <div class="vcard bio ">
                  <img src="images/person_1.jpg" alt="Image placeholder" className='bio' />
                </div>
              ...
              <li class="comment">
                <div class="vcard bio">
                  <img src="images/person_2.jpg" alt="Image placeholder" className='bio'/>
                </div>
                <div class="comment-body">
                ...
                <ul class="children">
                  <li class="comment">
                    <div class="vcard bio">
                      <img src="images/person_3.jpg" alt="Image placeholder" className='bio'/>
                    </div>
                    <div class="comment-body">
                      <h3>Chintan Patel</h3>
                      <div class="meta">January 9, 2018 at 2:21pm</div>
                    ...
                    <ul class="children">
                      <li class="comment">
                        <div class="vcard bio">
                          <img src="images/person_4.jpg" alt="Image placeholder" className='bio'/>
                        </div>
                        <div class="comment-body">
                          <h3>John Doe</h3>
                          <div class="meta">January 9, 2018 at 2:21pm</div>
                        ...
                        <ul class="children">
                          <li class="comment">
                            <div class="vcard bio">
                              <img src="images/person_5.jpg" alt="Image placeholder" className='bio'/>
                            </div>
                            <div class="comment-body">
                              <h3>Ben Afflick</h3>
                              <div class="meta">January 9, 2018 at 2:21pm</div>
        ...
        <div class="col-md-12 col-lg-1 order-lg-1">
          <div class="share sticky-top">
            ...
            <ul class="list-unstyled share-article">
              <li className='mt-4'><a href="#"><i class="bi bi-facebook shareicon"></i></a></li>
              <li className='mt-4'><a href="#"><i class="bi bi-twitter shareicon"></i></a></li>
              <li className='mt-4'><a href="#"><i class="bi bi-pinterest shareicon"></i></a></li>
            </ul>
          </div>
        </div>
